...
$nome = $_POST['nomeapagar'];

$query = mysqli_query($conexao, "SELECT * FROM usuarios WHERE nome = '$nome'");


echo ("O seguinte usuário e todas as suas informações foram devidamente apagados: <br> <br>");

while($result = mysqli_fetch_array($query)){
  
  echo "<table border='1' cellpadding='10px' bgcolor='#C0C0C0' width='60%'>
		<tr>
				<th> ID  </th> 
				<th> Nome  </th>
				<th> Senha  </th>
...
$query = mysqli_query($conexao, "DELETE FROM usuarios WHERE nome = '$nome'");
