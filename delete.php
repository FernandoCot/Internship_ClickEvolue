...
<head>
	...
	<!-- Essa é a Página de Exclusão, nela o usuário poderá testar aa funcionalidade de delete,
       ou seja, excluir informações do banco de dados.
...
<!--Início da Funcionalidade de Exclusão (Delete no Banco)-->

    <div class="container" id="Exclusao">

    <h4>Funcionalidade de Exclusão (Delete)</h4>

      <form method="Post" action="Excluir.php">

        <input type="text" placeholder="Nome de Usuário" name="nomeapagar"></input>

        <br>
        <br>

        <input type="submit" value="Apagar Informações"></input>

      </form>

    </div>

  <!-- Fim da Funcionalidade de Exclusão -->
