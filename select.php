...
<!--Início da Funcionalidade de Buscar Informações no Banco (Select no Banco) -->

    <div class="container" id="Busca">

    <h4>Funcionalidade de Busca (Select)</h4>

    <form method="Post" action="Buscar.php">
      <input type="text" placeholder="Nome de Usuário" name="nomebusca"></input>
      <br>
      <br>
 ...
 <!-- Fim da Funcionalidade de Localizar no Banco-->
</body>
