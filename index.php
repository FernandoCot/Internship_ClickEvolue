...
<head>
	...
	<!-- Essa é a Página Principal, nela o usuário poderá encontrar a página inicial
     com a navbar para testar as funcionalidades de insert, select, update e delete.
...
<!-- Frase Central -->
  ...
  <div class="container" id="frasecentral">

      <h1> Crud Funcional - Teste de Estágio </h1>
      <h4> (Selecione sua Operação na Barra de Navegação)</h4>
