...
<head>
	...
	<!-- Essa é a Página de "Busca Completa", nela o usuário poderá testar a funcionalidade de Select ALL, 
       ou seja, ver uma lista com todas as informações salvas atualmente no banco de dados.
...
<!-- Início da Funcionalidade de Mostrar Todos os Dados ao Usuário (Select "ALL" no banco) -->
...
<?php 
    ...
    echo "
    	<table border='1' cellpadding='10px' width='60%' id='titulotable' bgcolor='#C0C0C0'>
...
?>
  ...
  <!-- Fim da Funcionalidade de Select ALL -->
