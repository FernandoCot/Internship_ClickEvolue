...
<head>
	...
	<!-- Essa é a Página de Inserção, nela o usuário poderá testar a funcionalidade de insert,
       ou seja, adicionar registros ao banco de dados.
...
<!-- Início da Funcionalidade de Cadastrar Usuário (Insert no banco) -->

  <div class="container" id="Cadastro">

    <h4>Funcionalidade de Inserção (Insert)</h4>

    <form method="Post" action="adicionar.php">
      <input type="text" placeholder="Nome de Usuário" id="idnome" name="nomeins"></input>
      <br>
      <input type="password" placeholder="Senha" id="idsenha" name="senha"></input>
      <br>
      <input type="email" placeholder="Email" id="idemail" name="email"></input>
      <br>
      <br>
      <input type="submit" name="Adicionar" value="Adicionar" onclick="insertconfirmado();"></input>
    </form>

  </div>

  <!-- Fim da Funcionalidade de Cadastro -->
